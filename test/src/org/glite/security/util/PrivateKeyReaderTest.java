...
public class PrivateKeyReaderTest extends TestBase {
     ...
     * @throws IOException DOCUMENT ME!
     */
    protected BufferedInputStream openEncWithGarbage() throws IOException {
        return openFile(m_utilJavaRoot + "/test/input/trusted_client.priv");
    }
