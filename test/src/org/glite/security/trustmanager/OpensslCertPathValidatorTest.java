...
public class OpensslCertPathValidatorTest extends TestBase {
	...
	void setup(final boolean load) throws Exception {
		...
		certs.addElement(new TestItem("trusted-certs/trusted_server_exp", false, false, load));
                certs.addElement(new TestItem("trusted-certs/trusted_clientsha224", false, true, load));
                certs.addElement(new TestItem("trusted-certs/trusted_clientsha256", false, true, load));
                certs.addElement(new TestItem("trusted-certs/trusted_clientsha384", false, true, load));
                certs.addElement(new TestItem("trusted-certs/trusted_clientsha512", false, true, load));
